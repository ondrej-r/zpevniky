...
% =================================================================
% TOGGLE SWITCH: Set to 1 to hide repeating choruses, 0 to show all
\newcommand{\HideSubsequentChoruses}{1}
% =================================================================
...
% --- Automated Repetition Engine Setup ---
\newif\ifisrepeatingchorus%
\isrepeatingchorusfalse%
\newcommand{\repeatingchorus}{\global\isrepeatingchorustrue}
...
\xpretocmd{\endchorus}{%
  \ifnum\HideSubsequentChoruses=1\relax%
    ...
    \fi%
  \fi%
  \global\isrepeatingchorusfalse% Reset state context safely
}{}{}
        ...
        \def\SB@everypar{%
          \ifnum\HideSubsequentChoruses=1\relax%
            \ifisrepeatingchorus%
              ...
              \gdef\SB@everypar{}%
              \setbox\z@\vbox\bgroup\begingroup\chordedtrue%
            \else%
...
\begin{songs}{}
  \allsongs{
    \input{songslists/oddilovy_zpevnik_II_singer_songs_list.tex}
  }
\end{songs}
